...
/**
 * Payload for {@code POST /events}.
 * The creator is never taken from this payload — it is always resolved
 * from the authenticated principal. Status is not client-supplied either;
 * every new event starts out {@code UPCOMING}.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class EventCreateRequest {
    ...
    @FutureOrPresent(message = "Start date/time must not be in the past")
