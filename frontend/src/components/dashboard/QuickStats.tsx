      ...
      {statCards.map((card, idx) => {
        ...
        return (
          <motion.div
            ...
            className="p-4 rounded-2xl bg-card border border-border hover:border-primary/40 transition-all group"
          >
            ...
            <div>
              <div className="text-xl font-extrabold text-foreground tracking-tight group-hover:text-primary transition-colors">
                {card.value}
              </div>
              <div className="text-[10px] text-muted-foreground mt-1 font-medium">{card.subtitle}</div>
            </div>
          </motion.div>
        );
      })}
