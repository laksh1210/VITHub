  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {analytics.libraries.map((library) => {
        ...
        return (
          <div key={library.id} className="p-6 rounded-2xl bg-card border border-border space-y-6 shadow-xl">
            {/* Header */}
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-foreground tracking-tight">{library.name}</h3>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                <span>{availableRate.toFixed(1)}% Free ({library.totalSeats} Total)</span>
              </div>
