    ...
    <div className="p-6 rounded-2xl bg-card border border-border space-y-6 shadow-xl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-foreground tracking-tight">Campus Analytics & Distribution</h3>
            <p className="text-xs text-muted-foreground">Telemetry snapshot charts derived from live module endpoints</p>
          </div>
        </div>

        <div className="flex items-center gap-1.5 text-xs text-secondary px-2.5 py-1 rounded-full bg-primary/10 border border-primary/20">
