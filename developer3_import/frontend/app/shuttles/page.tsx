...
import { useAllCurrentShuttleLocations } from "@/hooks/use-shuttle-locations";
...
import { SHUTTLE_STATUSES, SHUTTLE_STATUS_LABEL } from "@/lib/types/enums";
...
export default function ShuttlesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {!isLoading && !isError && rows.length === 0 && (
        <EmptyState
          icon={shuttles && shuttles.length > 0 ? SearchX : TrafficCone}
